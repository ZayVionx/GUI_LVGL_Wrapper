...
/*================================== MACROS ==================================*/
/* 校验值 */
#define GUI_LV_DATA_CHECK_U16_VALUE(_data)                                     \
    do {                                                                       \
...
#define GUI_LV_DATA_CHECK_F_VALUE(_data)                                       \
    do {                                                                       \
...
/*============================= GLOBAL VARIABLES =============================*/
/*============================== LOCAL VARIABLES =============================*/
static gui_lv_data_t s_tGuiLvDataOps = {NULL};
                     ...
                     bool bIsWrap)
{
    ...
    GUI_LV_DATA_CHECK_U16_VALUE(ptRange);
    GUI_LV_DATA_CHECK_F_VALUE(ptRange);
    
    if (eType == GUI_LV_DATA_TYPE_INT)
    {
        if(eDit == GUI_LV_EDIT_ADD)
        {
        ...
        else if(eDit == GUI_LV_EDIT_REDUCE)
        {
    ...
    else if (eType == GUI_LV_DATA_TYPE_FLOAT)
    {
        if(eDit == GUI_LV_EDIT_ADD)
        {
